      ...
      <aside className={`w-64 bg-slate-900 text-white flex flex-col h-screen shrink-0 shadow-xl z-50 fixed md:relative transition-transform duration-300 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
        ...
        <nav className="flex-1 px-4 space-y-2 mt-6 text-sm font-medium">
          <Link
            ...
            className={`rounded-xl px-4 py-3 flex items-center gap-3 transition-all ${isActive('/dashboard')
          ...
          <Link
            ...
            className={`rounded-xl px-4 py-3 flex items-center gap-3 transition-all ${isActive('/users')
                ? 'bg-purple-600 text-white font-bold shadow-md shadow-purple-600/30'
                : 'text-slate-400 hover:bg-slate-800 hover:text-white'
              }`}
          >
          ...
          <Link
            ...
            className={`rounded-xl px-4 py-3 flex items-center gap-3 transition-all ${isActive('/complaints')
                ? 'bg-purple-600 text-white font-bold shadow-md shadow-purple-600/30'
                : 'text-slate-400 hover:bg-slate-800 hover:text-white'
              }`}
          >
        ...
        <div className="p-4 border-t border-slate-800 flex flex-col gap-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-purple-400 font-semibold truncate capitalize">Super Admin</p>
            </div>
          </div>
