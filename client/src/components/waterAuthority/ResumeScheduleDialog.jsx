...
export default function ResumeScheduleDialog({ isOpen, onClose, onConfirm, schedule }) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start', margin: '0.5rem 0' }}>
          <span className="material-symbols-outlined" style={{ fontSize: '2.2rem', color: 'var(--water-success)' }}>
            play_circle
          </span>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
            <p style={{ fontSize: '0.88rem', color: 'var(--water-text)', fontWeight: '600' }}>
              Are you sure you want to resume this water supply schedule?
            </p>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          ...
          <textarea
            ...
            placeholder="Provide any remarks about resuming supply (e.g. maintenance complete, pressure normalized)"
            style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'flex-end', marginTop: '0.75rem' }}>
            ...
            <button 
              ...
              style={{ 
                padding: '0.5rem 1rem', 
                backgroundColor: 'var(--water-success)', 
                color: '#ffffff', 
                border: 'none',
                borderRadius: '6px',
                fontWeight: '600',
