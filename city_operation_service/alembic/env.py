...
# Add the city_operation_service directory to sys.path
...
def include_object(object, name, type_, reflected, compare_to):
    if type_ == "table":
        # Only touch tables belonging to city_operation_service
        return name in CITY_OPS_TABLES
    return True
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table="alembic_version_city_ops",
    )
